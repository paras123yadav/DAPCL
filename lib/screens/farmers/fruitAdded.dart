...
class FruitAdded extends StatefulWidget {
  final String userID;
  FruitAdded( {Key? key,required this.userID}) : super(key: key);

  @override
  State<FruitAdded> createState() => _FruitAddedState();
}

class _FruitAddedState extends State<FruitAdded> {
