        ...
        children: <Widget>[
            ...
            child: TextField(
              ...
              decoration:  InputDecoration(
                suffixIcon: isPasswordTextField
                  ...
                  onPressed: () {
                    setState(() {
                      showPassword==true?_iconColor = Colors.black:_iconColor = Colors.grey;
          ...
          SizedBox(
            ...
            child: Row(
              ...
              children: [
                Text("Forgot Password?",style: TextStyle(color: Colors.redAccent,fontWeight: FontWeight.w600,fontSize: 16),),
              ],
            ),
          ),
          SizedBox(
  ...
  Future<bool> verifyLogin(String phone, String password) async{
    ...
    if(json["status"]=="1") {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (context){
            return BottomNavigationBarController(phone:phone,password: password);
          }
          )
      );
      // print("SUccess");
