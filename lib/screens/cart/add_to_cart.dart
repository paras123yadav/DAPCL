      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            SizedBox(
              child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return cartList(vegname[index],items[index],vegprice[index],vegquantity[index],ans);
                  }
              ),
            ...
            lund!=true?customCartButton():customCartButton(),
          ],
        ),
      ),
    );
          ...
          child: Row(
            ...
            children: [
              Padding(
                ...
                child: Text("Rs.${ans.value}",style: TextStyle(fontSize: 18,color: Colors.white),),
              ),
              custom()
            ],
          ),
...
class cartList extends StatefulWidget {
  ...
  cartList(this.vegnam,this.items, this.vegprice, this.vegquantity,this.ans,{Key? key}) : super(key: key);
